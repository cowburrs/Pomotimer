...
let
  nixifiedLockHash = "ca4a97c3de6844e6fb56f8d639791f715c3df0d492edf16ec3edcdaba965b0e5";
...
in
{
  ...
  workspace = {
    Pomotimer = rustPackages.unknown.Pomotimer."0.1.0";
  };
  "unknown".Pomotimer."0.1.0" = overridableMkRustCrate (profileName: rec {
    name = "Pomotimer";
    version = "0.1.0";
    registry = "unknown";
